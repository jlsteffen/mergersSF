...
The profiles of the control galaxies are centrally quenched, which was previously seen in the MaNGA sample in \citet{Belfiore:2018}. The profiles of the paired galaxies flat across the whole galaxy accept for galaxies with masses above \logm\ $=$ 10.5 which show some central quenching. When taking the difference between the pairs and controls, the paired profiles are centrally enhanced by $\sim$0.25 $\pm$ 0.1 dex. This enhancement linearly falls to zero around 1.0 $R$/\reff. In the disks the profiles feature a weak suppression to the sSFR of 0.05$-$0.1 dex. 
...
Once the average profile of the control galaxies is made, we take the difference between the paired galaxy's profile and the average control profile in log space. We do this process for each of the 175 paired galaxies. 
