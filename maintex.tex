...
%%% Reddening
We correct the emission lines for reddening using the extinction curve from \citet{Cardelli:1989} with updated coefficients from \citet{ODonnell:1994}. The extinction is parameterized as R$_V$ $\equiv$ A$_V$/E(B$-$V) $=$ 3.1, where we estimate the value of the V-band extinction, A$_V$, by comparing the H$\alpha$/H$\beta$ ratio to the expected value of 2.85 for case-B recombination. 

We measure the SFR from the extinction corrected H$\alpha$ luminosity, L$_{{\rm H}\alpha}$.  We use the SFR formula, Equation \ref{eq:sfr}, from \citet{Murphy:2011} which uses a Kroupa IMF, Solar metallicity, a constant SFR at an age of 100 Myr, and Case-B recombination. 
...
\subsection{Enhanced Pairs or Quenched Controls}

In Figure \ref{fig:ssfr_prof}, we showed the stacked sSFR profiles of control galaxies and paired galaxies. The control galaxies are quenched in their centers with respect to their disks and the difference between the sSFR in their centers and their disks increases with higher stellar masses (which was previously seen in the MaNGA survey in \citet{Belfiore:2018}). The paired galaxies show flattened star formation profiles where the level of the sSFR remains roughly consistent across their disks except for paired galaxies with stellar masses above \logm\ $=$ 10.5 which still show some central quenching. This indicates that the central offsets viewed in the difference profiles is largely driven by the centrally quenched controls. Because of this it may be more proper to describe isolated galaxies as being centrally quenched or that the profiles of paired galaxies are flattened in their centers with respect to their controls. 

The flattening of the paired galaxies' profiles seems to indicate that the merger event can ``un-quench" the centers of the galaxies. The mode of inside-out quenching that seems most consistent with our results is the gas depletion model where the galaxy runs out of cold gas in their centers. In the merger event, new gases are brought into the centers of the galaxies by the merger induced gas inflows which are then able to facilitate new star formation. 

After the merger induced starburst, it is unclear whether the galaxy will return to the same level of central quenching or if the resulting galaxy is more quenched. From Figure \ref{fig:ssfr_prof}, we see that more massive galaxies are more quenched than less massive galaxies. Since the resulting galaxy after the merger process will be more massive than it was before and since the most massive galaxies have likely gone through multiple past merging events \citep{Rodriguez-Gomez:2016, Pillepich:2018}, it is reasonable to believe that the long term result of the merger event is a more quenched galaxy. In this situation, the merger event temporarily alleviates the galaxy from its quenched state; however, when starburst ends the galaxy is more quenched than it was before.  
...
\item The sSFR enhancement in paired galaxies is independent of the total stellar mass of the paired galaxies.
...
\item The secondary companions of a galaxy pair, the less massive galaxy, show higher sSFR enhancements, by $\sim$0.1 dex in comparison to primary companions at the same mass ratio. Further, primary companions have zero to positive sSFR offsets in their ouskirts, $\Delta$log(sSFR) $=$ 0.0$-$0.3 dex. Secondary companions feature a sSFR suppression in their outskirts of 0.0$-$0.3 dex.
\item The sSFR enhancement increases with closer projected separations where galaxies within 5$-$15 kpc have their sSFR enhanced by 0.3$-$0.4. 
